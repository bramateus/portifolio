...
<section class="container-fluid mt-4">
    ...
    <div class="row">
        ...
        <!-- </div> -->
        <div class="col-xs-12 col-md-12 col-mdd-4 col-lg-5 col-xl-12  text-ligh mt-5 pt-5 aux">
        
            <div class="container" style="text-align: center; margin-top: 50px">
                <h1 style="padding-bottom: 30px; font-weight: bold;  font-family: rounded">OBRIGADO!</h1>
                <h2 style=" font-family: rounded">Em breve um de nossos<br>consultores entrará<br> em contato com você.</h2>

                <div style="padding-top: 25px"><img src="https://doceleitura.com.br/dashboard/uploads/d0eb8522-5832-4aa7-b65a-60adf8ad1def/LogoDoceLeitura.png" alt=""></div>
            </div>
